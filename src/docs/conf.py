...
latex_documents = [
    (master_doc, 'MeteorPi.tex', u'Triangula Documentation',
     u'Tom Oinn, Simon Rodgers', 'manual'),
]
...
man_pages = [
    (master_doc, 'triangula', u'Triangula Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Triangula', u'Triangula Documentation',
     author, 'Triangula', 'One line description of project.',
     'Miscellaneous'),
]
