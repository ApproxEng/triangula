...
handler function, then register that function with the :class:`triangula.input.SixAxis` instance:
...
You can do this with the get_and_clear_button_press_history function. The :class:`triangula.input.SixAxis` instance
